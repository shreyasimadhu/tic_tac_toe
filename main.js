	...
	function ticTacToe(i, j) {
		...
		if (flag==1) {
			alert("Congratulations "+ s1 +"! You won!");
			over=1;
	...
	function ticTacToe2(i, j) {
		if(turnp==1)
		{
			...
			turnp=1;
			document.getElementById('p2').innerHTML=s1 +"'s chance";
		}
	...
	function showOne()
	{
		...
		document.getElementById('p2').style.visibility='hidden';
		s1=prompt("Please enter your name","Shereyase Madhu");
		if(!s1)
		 s1 = "Shereyase Madhu";
		game=1;
	}
	...
	function showTwo()
	{
		...
		document.getElementById('homeP').style.display='none';
		document.getElementById('grid').style.visibility="";
		s1=prompt("Player1, Please enter your name","Shereyase Madhu");
		p2=prompt("Player2, Please enter your name","Prothes Barai");
		if(!s1) s1 = "Shereyase Madhu";
		if(!p2) p2 = "Prothes Barai";		
		game=2;
